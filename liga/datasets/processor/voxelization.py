...
# COOR_TO_VOXELIDX2 = 65535 * np.ones(shape=(40, 608, 1216), dtype=np.uint16)
# COOR_TO_VOXELIDX2 = 65535 * np.ones(shape=(10, 1216, 608), dtype=np.uint16)
COOR_TO_VOXELIDX2 = 65535 * np.ones(shape=(20, 608, 776), dtype=np.uint16)
